...
var answerPageHeaderElement=`<ul class="section__main__listView2" id="listView"><li><div><div style="width: 32px;float: left;"><img src="img/star1.png" alt="star"></div><div><a href="#"><h2>Questions for you</h2></a></div></div></li></ul>`;
var questionPageHeaderElement=`<ul class="section__main__listView2" id="listView"><li><div><div style="width: 32px;float: left;"><img src="img/star1.png" alt="star"></div><div><a href="#"><h2>Questions of you</h2></a></div></div></li></ul>`;
...
$(function(){
    ...
    $('#Answer').click(function (e) { 
        ...
        $('.section__main').html(answerPageHeaderElement);
        loadAnswerPageData();
    });
    ...
    function loadAnswerPageData(){
        for(var i=0;i<10;i++){
            $('#listView').append(answerPageData);
        }
    }
